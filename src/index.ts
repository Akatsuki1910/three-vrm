...
function returnBone(vrm: any, boneSt: String) {
	...
	switch (boneSt) {
		case "Chest":
			bone = VRMSchema.HumanoidBoneName.Chest;
			break;
		case "Head":
			bone = VRMSchema.HumanoidBoneName.Head;
			break;
		case "Hips":
			bone = VRMSchema.HumanoidBoneName.Hips;
			break;
		case "Jaw":
			bone = VRMSchema.HumanoidBoneName.Jaw;
			break;
		case "LeftEye":
			bone = VRMSchema.HumanoidBoneName.LeftEye;
			break;
		case "LeftFoot":
			bone = VRMSchema.HumanoidBoneName.LeftFoot;
			break;
		case "LeftHand":
			bone = VRMSchema.HumanoidBoneName.LeftHand;
			break;
		case "LeftIndexDistal":
			bone = VRMSchema.HumanoidBoneName.LeftIndexDistal;
			break;
		case "LeftIndexIntermediate":
			bone = VRMSchema.HumanoidBoneName.LeftIndexIntermediate;
			break;
		case "LeftIndexProximal":
			bone = VRMSchema.HumanoidBoneName.LeftIndexProximal;
			break;
		case "LeftLittleDistal":
			bone = VRMSchema.HumanoidBoneName.LeftLittleDistal;
			break;
		case "LeftLittleIntermediate":
			bone = VRMSchema.HumanoidBoneName.LeftLittleIntermediate;
			break;
		case "LeftLittleProximal":
			bone = VRMSchema.HumanoidBoneName.LeftLittleProximal;
			break;
		case "LeftLowerArm":
			bone = VRMSchema.HumanoidBoneName.LeftLowerArm;
			break;
		case "LeftLowerLeg":
			bone = VRMSchema.HumanoidBoneName.LeftLowerLeg;
			break;
		case "LeftMiddleDistal":
			bone = VRMSchema.HumanoidBoneName.LeftMiddleDistal;
			break;
		case "LeftMiddleIntermediate":
			bone = VRMSchema.HumanoidBoneName.LeftMiddleIntermediate;
			break;
		case "LeftMiddleProximal":
			bone = VRMSchema.HumanoidBoneName.LeftMiddleProximal;
			break;
		case "LeftRingDistal":
			bone = VRMSchema.HumanoidBoneName.LeftRingDistal;
			break;
		case "LeftRingIntermediate":
			bone = VRMSchema.HumanoidBoneName.LeftRingIntermediate;
			break;
		case "LeftRingProximal":
			bone = VRMSchema.HumanoidBoneName.LeftRingProximal;
			break;
		case "LeftShoulder":
			bone = VRMSchema.HumanoidBoneName.LeftShoulder;
			break;
		case "LeftThumbDistal":
			bone = VRMSchema.HumanoidBoneName.LeftThumbDistal;
			break;
		case "LeftThumbIntermediate":
			bone = VRMSchema.HumanoidBoneName.LeftThumbIntermediate;
			break;
		case "LeftThumbProximal":
			bone = VRMSchema.HumanoidBoneName.LeftThumbProximal;
			break;
		case "LeftToes":
			bone = VRMSchema.HumanoidBoneName.LeftToes;
			break;
		case "LeftUpperArm":
			bone = VRMSchema.HumanoidBoneName.LeftUpperArm;
			break;
		case "LeftUpperLeg":
			bone = VRMSchema.HumanoidBoneName.LeftUpperLeg;
			break;
		case "Neck":
			bone = VRMSchema.HumanoidBoneName.Neck;
			break;
		case "RightEye":
			bone = VRMSchema.HumanoidBoneName.RightEye;
			break;
		case "RightFoot":
			bone = VRMSchema.HumanoidBoneName.RightFoot;
			break;
		case "RightHand":
			bone = VRMSchema.HumanoidBoneName.RightHand;
			break;
		case "RightIndexDistal":
			bone = VRMSchema.HumanoidBoneName.RightIndexDistal;
			break;
		case "RightIndexIntermediate":
			bone = VRMSchema.HumanoidBoneName.RightIndexIntermediate;
			break;
		case "RightIndexProximal":
			bone = VRMSchema.HumanoidBoneName.RightIndexProximal;
			break;
		case "RightLittleDistal":
			bone = VRMSchema.HumanoidBoneName.RightLittleDistal;
			break;
		case "RightLittleIntermediate":
			bone = VRMSchema.HumanoidBoneName.RightLittleIntermediate;
			break;
		case "RightLittleProximal":
			bone = VRMSchema.HumanoidBoneName.RightLittleProximal;
			break;
		case "RightLowerArm":
			bone = VRMSchema.HumanoidBoneName.RightLowerArm;
			break;
		case "RightLowerLeg":
			bone = VRMSchema.HumanoidBoneName.RightLowerLeg;
			break;
		case "RightMiddleDistal":
			bone = VRMSchema.HumanoidBoneName.RightMiddleDistal;
			break;
		case "RightMiddleIntermediate":
			bone = VRMSchema.HumanoidBoneName.RightMiddleIntermediate;
			break;
		case "RightMiddleProximal":
			bone = VRMSchema.HumanoidBoneName.RightMiddleProximal;
			break;
		case "RightRingDistal":
			bone = VRMSchema.HumanoidBoneName.RightRingDistal;
			break;
		case "RightRingIntermediate":
			bone = VRMSchema.HumanoidBoneName.RightRingIntermediate;
			break;
		case "RightRingProximal":
			bone = VRMSchema.HumanoidBoneName.RightRingProximal;
			break;
		case "RightShoulder":
			bone = VRMSchema.HumanoidBoneName.RightShoulder;
			break;
		case "RightThumbDistal":
			bone = VRMSchema.HumanoidBoneName.RightThumbDistal;
			break;
		case "RightThumbIntermediate":
			bone = VRMSchema.HumanoidBoneName.RightThumbIntermediate;
			break;
		case "RightThumbProximal":
			bone = VRMSchema.HumanoidBoneName.RightThumbProximal;
			break;
		case "RightToes":
			bone = VRMSchema.HumanoidBoneName.RightToes;
			break;
		case "RightUpperArm":
			bone = VRMSchema.HumanoidBoneName.RightUpperArm;
			break;
		case "RightUpperLeg":
			bone = VRMSchema.HumanoidBoneName.RightUpperLeg;
			break;
		case "Spine":
			bone = VRMSchema.HumanoidBoneName.Spine;
			break;
		case "UpperChest":
			bone = VRMSchema.HumanoidBoneName.UpperChest;
			break;
	}
